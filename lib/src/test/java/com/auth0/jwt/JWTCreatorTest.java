...
import com.auth0.jwt.algorithms.ECDSA256Factory;
import com.auth0.jwt.algorithms.HMAC256Factory;
import com.auth0.jwt.algorithms.RSA256Factory;
...
public class JWTCreatorTest {
    ...
    public void shouldAddKeyIdIfAvailableFromRSAAlgorithms() throws Exception {
        ...
        String signed = JWTCreator.init()
                .sign(new RSA256Factory(provider).create());
    ...
    public void shouldAddKeyIdIfAvailableFromECDSAAlgorithms() throws Exception {
        ...
        String signed = JWTCreator.init()
                .sign(new ECDSA256Factory(provider).create());
    ...
    public void shouldPreserveInsertionOrder() throws Exception {
        ...
        String signed = builder.sign(new HMAC256Factory("secret").create());
