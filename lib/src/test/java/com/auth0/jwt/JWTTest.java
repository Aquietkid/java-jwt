...
public class JWTTest {
    ...
    public void shouldVerifyDecodedToken() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(new RSA512Factory(key).create())
                .build()
                .verify(decodedJWT);
    ...
    public void shouldAcceptHMAC256Algorithm() {
        String token = "eyJhbGciOiJIUzI1NiIsImN0eSI6IkpXVCJ9.eyJpc3MiOiJhdXRoMCJ9.mZ0m_N1J4PgeqWmi903JuUoDRZDBPB7HwkS4nVyWH1M";
        DecodedJWT jwt = JWT.require(new HMAC256Factory("secret").create())
                .build()
                .verify(token);
    ...
    public void shouldAcceptHMAC384Algorithm() {
        ...
        DecodedJWT jwt = JWT.require(new HMAC384Factory("secret").create())
                .build()
                .verify(token);
    ...
    public void shouldAcceptHMAC512Algorithm() {
        ...
        DecodedJWT jwt = JWT.require(new HMAC512Factory("secret").create())
                .build()
                .verify(token);
    ...
    public void shouldAcceptRSA256Algorithm() throws Exception {
        ...
        RSAKey key = (RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA");
        DecodedJWT jwt = JWT.require(new RSA256Factory(key).create())
                .build()
                .verify(token);
    ...
    public void shouldAcceptRSA384Algorithm() throws Exception {
        ...
        RSAKey key = (RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA");
        DecodedJWT jwt = JWT.require(new RSA384Factory(key).create())
                .build()
                .verify(token);
    ...
    public void shouldAcceptECDSA256Algorithm() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(new ECDSA256Factory(key).create())
                .build()
                .verify(token);
    ...
    public void shouldAcceptECDSA384Algorithm() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(new ECDSA384Factory(key).create())
                .build()
                .verify(token);
    ...
    public void shouldAcceptECDSA512Algorithm() throws Exception {
        ...
        DecodedJWT jwt = JWT.require(new ECDSA512Factory(key).create())
                .build()
                .verify(token);
    ...
    public void shouldGetExpirationTime() {
        ...
        JWTVerifier.BaseVerification verification = (JWTVerifier.BaseVerification) JWT.require(new HMAC256Factory("secret").create());
    ...
    public void shouldCreateAnEmptyHMAC256SignedToken() {
        String signed = JWT.create().sign(new HMAC256Factory("secret").create());
        ...
        JWTVerifier verified = JWT.require(new HMAC256Factory("secret").create())
                .build();
    ...
    public void shouldCreateAnEmptyHMAC384SignedToken() {
        String signed = JWT.create().sign(new HMAC384Factory("secret").create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new HMAC384Factory("secret").create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyHMAC512SignedToken() {
        String signed = JWT.create().sign(new HMAC512Factory("secret").create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new HMAC512Factory("secret").create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyRSA256SignedToken() throws Exception {
        String signed = JWT.create().sign(new RSA256Factory((RSAKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_RSA, "RSA")).create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new RSA256Factory((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA")).create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyRSA384SignedToken() throws Exception {
        String signed = JWT.create().sign(new RSA384Factory((RSAKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_RSA, "RSA")).create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new RSA384Factory((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA")).create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyRSA512SignedToken() throws Exception {
        String signed = JWT.create().sign(new RSA512Factory((RSAKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_RSA, "RSA")).create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new RSA512Factory((RSAKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_RSA, "RSA")).create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyECDSA256SignedToken() throws Exception {
        String signed = JWT.create().sign(new ECDSA256Factory((ECKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_EC_256, "EC")).create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new ECDSA256Factory((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_256, "EC")).create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyECDSA384SignedToken() throws Exception {
        String signed = JWT.create().sign(new ECDSA384Factory((ECKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_EC_384, "EC")).create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new ECDSA384Factory((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_384, "EC")).create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
    ...
    public void shouldCreateAnEmptyECDSA512SignedToken() throws Exception {
        String signed = JWT.create().sign(new ECDSA512Factory((ECKey) PemUtils.readPrivateKeyFromFile(PRIVATE_KEY_FILE_EC_512, "EC")).create());
        assertThat(signed, is(notNullValue()));
        ...
        JWTVerifier verified = JWT.require(new ECDSA512Factory((ECKey) PemUtils.readPublicKeyFromFile(PUBLIC_KEY_FILE_EC_512, "EC")).create())
                .build();
        assertThat(verified, is(notNullValue()));
    }
}
