...
public class ECDSAAlgorithmTest {
    ...
    public void shouldPassECDSA256VerificationWithJOSESignatureWithBothKeys() throws Exception {
        String jwt = "eyJhbGciOiJFUzI1NiJ9.eyJpc3MiOiJhdXRoMCJ9.4iVk3-Y0v4RT4_9IaQlp-8dZ_4fsTzIylgrPTDLrEvTHBTyVS3tgPbr2_IZfLETtiKRqCg0aQ5sh9eIsTTwB1g";
        Algorithm algorithm = new ECDSA256Factory((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldFailECDSA256VerificationWithInvalidPublicKey() throws Exception {
        ...
        Algorithm algorithm = new ECDSA256Factory((ECKey) readPublicKeyFromFile(INVALID_PUBLIC_KEY_FILE_256, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldFailECDSA256VerificationWhenUsingPrivateKey() throws Exception {
        ...
        exception.expectCause(hasMessage(is("The given Public Key is null.")));
        String jwt = "eyJhbGciOiJFUzI1NiJ9.eyJpc3MiOiJhdXRoMCJ9.W9qfN1b80B9hnMo49WL8THrOsf1vEjOhapeFemPMGySzxTcgfyudS5esgeBTO908X5SLdAr5jMwPUPBs9b6nNg";
        Algorithm algorithm = new ECDSA256Factory((ECKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldPassECDSA384VerificationWithJOSESignatureWithBothKeys() throws Exception {
        String jwt = "eyJhbGciOiJFUzM4NCJ9.eyJpc3MiOiJhdXRoMCJ9.50UU5VKNdF1wfykY8jQBKpvuHZoe6IZBJm5NvoB8bR-hnRg6ti-CHbmvoRtlLfnHfwITa_8cJMy6TenMC2g63GQHytc8rYoXqbwtS4R0Ko_AXbLFUmfxnGnMC6v4MS_z";
        Algorithm algorithm = new ECDSA384Factory((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_384, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_384, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldFailECDSA384VerificationWithInvalidPublicKey() throws Exception {
        ...
        Algorithm algorithm = new ECDSA384Factory((ECKey) readPublicKeyFromFile(INVALID_PUBLIC_KEY_FILE_384, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldFailECDSA384VerificationWhenUsingPrivateKey() throws Exception {
        ...
        exception.expectCause(hasMessage(is("The given Public Key is null.")));
        String jwt = "eyJhbGciOiJFUzM4NCJ9.eyJpc3MiOiJhdXRoMCJ9._k5h1KyO-NE0R2_HAw0-XEc0bGT5atv29SxHhOGC9JDqUHeUdptfCK_ljQ01nLVt2OQWT2SwGs-TuyHDFmhPmPGFZ9wboxvq_ieopmYqhQilNAu-WF-frioiRz9733fU";
        Algorithm algorithm = new ECDSA384Factory((ECKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_384, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldPassECDSA512VerificationWithJOSESignatureWithBothKeys() throws Exception {
        String jwt = "eyJhbGciOiJFUzUxMiJ9.eyJpc3MiOiJhdXRoMCJ9.AeCJPDIsSHhwRSGZCY6rspi8zekOw0K9qYMNridP1Fu9uhrA1QrG-EUxXlE06yvmh2R7Rz0aE7kxBwrnq8L8aOBCAYAsqhzPeUvyp8fXjjgs0Eto5I0mndE2QHlgcMSFASyjHbU8wD2Rq7ZNzGQ5b2MZfpv030WGUajT-aZYWFUJHVg2";
        Algorithm algorithm = new ECDSA512Factory((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_512, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_512, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldFailECDSA512VerificationWithInvalidPublicKey() throws Exception {
        ...
        Algorithm algorithm = new ECDSA512Factory((ECKey) readPublicKeyFromFile(INVALID_PUBLIC_KEY_FILE_512, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldFailECDSA512VerificationWhenUsingPrivateKey() throws Exception {
        ...
        exception.expectCause(hasMessage(is("The given Public Key is null.")));
        String jwt = "eyJhbGciOiJFUzUxMiJ9.eyJpc3MiOiJhdXRoMCJ9.AZgdopFFsN0amCSs2kOucXdpylD31DEm5ChK1PG0_gq5Mf47MrvVph8zHSVuvcrXzcE1U3VxeCg89mYW1H33Y-8iAF0QFkdfTUQIWKNObH543WNMYYssv3OtOj0znPv8atDbaF8DMYAtcT1qdmaSJRhx-egRE9HGZkinPh9CfLLLt58X";
        Algorithm algorithm = new ECDSA512Factory((ECKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_512, "EC")).create();
        algorithm.verify(JWT.decode(jwt));
    }
    ...
    public void shouldDoECDSA256Signing() throws Exception {
        Algorithm algorithm = new ECDSA256Factory((ECKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC")).create();
        Algorithm algorithmVerify = new ECDSA256Factory((ECKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC")).create();
    ...
    public void shouldFailOnECDSA256SigningWhenUsingPublicKey() throws Exception {
        ...
        Algorithm algorithm = new ECDSA256Factory((ECKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC")).create();
        algorithm.sign(new byte[0], new byte[0]);
    }

    @Test
    public void shouldDoECDSA384Signing() throws Exception {
        Algorithm algorithmSign = new ECDSA384Factory((ECKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_384, "EC")).create();
        Algorithm algorithmVerify = new ECDSA384Factory((ECKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_384, "EC")).create();
    ...
    public void shouldFailOnECDSA384SigningWhenUsingPublicKey() throws Exception {
        ...
        Algorithm algorithm = new ECDSA384Factory((ECKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_384, "EC")).create();
        algorithm.sign(new byte[0], new byte[0]);
    }

    @Test
    public void shouldDoECDSA512Signing() throws Exception {
        Algorithm algorithmSign = new ECDSA512Factory((ECKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_512, "EC")).create();
        Algorithm algorithmVerify = new ECDSA512Factory((ECKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_512, "EC")).create();
    ...
    public void shouldFailOnECDSA512SigningWhenUsingPublicKey() throws Exception {
        ...
        Algorithm algorithm = new ECDSA512Factory((ECKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_512, "EC")).create();
        algorithm.sign(new byte[0], new byte[0]);
    }
    ...
    public void shouldThrowOnDERSignatureConversionIfDoesNotStartWithCorrectSequenceByte() throws Exception {
        ...
        ECDSAAlgorithm algorithm256 = (ECDSAAlgorithm) new ECDSA256Factory((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC")).create();
    ...
    public void shouldThrowOnJOSESignatureConversionIfDoesNotHaveExpectedLength() throws Exception {
        ECPublicKey publicKey = (ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_256, "EC");
        ECDSAAlgorithm algorithm256 = (ECDSAAlgorithm) new ECDSA256Factory(publicKey, (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC")).create();
    ...
    public void shouldSignAndVerifyWithECDSA384() throws Exception {
        ECDSAAlgorithm algorithm384 = (ECDSAAlgorithm) new ECDSA384Factory((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_384, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_384, "EC")).create();
    ...
    public void shouldSignAndVerifyWithECDSA512() throws Exception {
        ECDSAAlgorithm algorithm512 = (ECDSAAlgorithm) new ECDSA512Factory((ECPublicKey) readPublicKeyFromFile(PUBLIC_KEY_FILE_512, "EC"), (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_512, "EC")).create();
    ...
    public void invalidECDSA256SignatureShouldFailTokenVerification() throws Exception {
        ...
        JWTVerifier verifier256 = JWT.require(new ECDSA256Factory(key256).create()).build();
        JWTVerifier verifier384 = JWT.require(new ECDSA256Factory(key384).create()).build();
        JWTVerifier verifier512 = JWT.require(new ECDSA256Factory(key512).create()).build();
    ...
    public void signatureWithAllZerosShouldFail() throws Exception {
        ...
        ECDSAAlgorithm algorithm256 = (ECDSAAlgorithm) new ECDSA256Factory(pubKey, (ECPrivateKey) readPrivateKeyFromFile(PRIVATE_KEY_FILE_256, "EC")).create();
    ...
    public void signatureWithRZeroShouldFail() throws Exception {
        ...
        String signedJwt = JWT.create().sign(new ECDSA256Factory(publicKey, privateKey).create());
        ...
        ECDSAAlgorithm algorithm256 = (ECDSAAlgorithm) new ECDSA256Factory(publicKey, privateKey).create();
